...
#define CALL_DYNAMIC_FUNC(name, ret_type, ret_name) ret_type name(DYNAMIC_FUNC_ARG_TYPES); ret_type ret_name = name(DYNAMIC_FUNC_ARG_NAMES);
#define CALL_DYNAMIC_FUNC_VOID(name) void name(DYNAMIC_FUNC_ARG_TYPES); name(DYNAMIC_FUNC_ARG_NAMES);
#endif
